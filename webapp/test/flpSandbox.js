		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample App",
									"targetURL": "#commobosasample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commobosasample-display": {
								"semanticObject": "commobosasample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mobo.sa.sample",
									"url": sap.ui.require.toUrl("com/mobo/sa/sample")
								}
							}
						}
					}
